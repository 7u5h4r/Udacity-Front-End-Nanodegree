...
JUSTICE_LEAGUE = media.Movie("Justice League",
                             "Justice League is a 2017 American"
                             "superhero film, based on the DC Comics"
                             "superhero team of the same name"
                             "consisting of Batman, Superman, Wonder Woman,"
...
BLACK_PANTHER = media.Movie("Black Panther",
                            "lack Panther is an upcoming American"
...
HOTEL_TRANSYLVANIA_3 = media.Movie("Hotel Transylvania 3",
                                   ...
                                   "as Hotel Transylvania 3"
                                   ": A Monster Vacation",
                                   "https://upload.wikimedia.org/wi"
                                   "kipedia/en/9/9e/"
                                   "Hotel_Transylvania_3_%28201"
                                   "8%29_Poster.jpg",
...
X_Men = media.Movie("X-Men: The New Mutants",
                    ...
                    "team of the same name and distributed by"
                    "20th Century Fox.",
                    "https://upload.wikimedia.org/wikipedia"
...
Aladdin = media.Movie("Aladdin - The Cave of Wonders",
                      ...
                      "is the latest Disney classic"
                      "to be given a live action remake."
                      "Following in the footsteps"
                      "of Maleficent, The Jungle Book,"
                      "Beauty and the Beast and The"
                      "Lion King Reborn, come join Aladdin"
                      "in a brand new adventure.",
                      "https://vignette.wikia.nocookie.net/"
                      "disney/images/9/96/MPW-10542.jpg",
                      "https://www.youtube.com/watch?v=SN5Y6Bqxclw")

# list named movies is created that consists of above instances
movies = [JUSTICE_LEAGUE, Thor, BLACK_PANTHER,
          HOTEL_TRANSYLVANIA_3, X_Men, Aladdin]
